...
class Student:
    ...
    def __init__(self,name,age,grade):
        ...
        Student.id+=1 #student id is incremented
...
s1=Student("Anitha",17,12)#s1 is the instance of the class Student
s2=Student("Priya",16,11)#s2 is another instance of the class Student
s3=Student("Sahil",15,10)#s3 is also an instance of the class Student
s4=Student("Aadhyansh",11,6)#s4 is also an instance of the class Student
s1.display()
s2.display()
